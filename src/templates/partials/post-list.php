<h2 class="u-hiddenVisually">Tidigare projekt</h2>

<div class="PostList">

  <?php foreach ( $post_list_items as $key=>$post ): setup_postdata( $post ); ?>
        ...
        <div class="Type Type--plain">
          <p>
            <strong class="u-block">
              <span class="u-hiddenVisually">Läs om: </span> <?php the_title(); ?>
            </strong>
